...
def write_csv(pagedata):
    with open('Greece.csv', 'w',encoding='utf-8', newline='') as csvFile:
...
if __name__ == "__main__":
    ...
    start_url = 'https://www.dacia.gr/dealerlocator.html'
    ...
    for elem in elems:
        ...
        carddetail={'name':elem.find_element_by_css_selector('.dealer-name').text,
                    ...
                    'phone':elem.find_element_by_css_selector('.dealer-contact-data a span.phone-number').text,'fax':elem.find_elements_by_css_selector('.dealer-contact-data span.phone-number')[1].text}
